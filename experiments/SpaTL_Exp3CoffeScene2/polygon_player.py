...
if __name__ == '__main__':
    ...
    specification += 'and (F[300,450] (orange rightof cookies) )'
    specification += 'and ( (not((mug leftof plate) and (mug closeto plate))) U (orange ovlp plate))'
    specification += 'and (F (coffee rightof plate) and (milk closeto coffee) and (milk rightof coffee) and (jug rightof milk) )'
